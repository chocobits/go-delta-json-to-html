...
// TestRomanList verifies that a list with a custom ordered subtype ("roman") is
// emitted as an <ol> with a data-list-type attribute and that alignment classes
// are applied to the <li> elements.
func TestRomanList(t *testing.T) {
	ops := `[{"insert":"Primeiro item"},{"insert":"\n","attributes":{"align":"justify","list":"roman"}},{"insert":"Segundo item"},{"insert":"\n","attributes":{"align":"justify","list":"roman"}},{"insert":"Terceiro item"},{"insert":"\n","attributes":{"align":"justify","list":"roman"}}]`
	want := `<ol data-list-type="roman"><li class="align-justify">Primeiro item</li><li class="align-justify">Segundo item</li><li class="align-justify">Terceiro item</li></ol>`
	...
	if string(got) != want {
		t.Errorf("roman list rendering mismatch\nwant: %s\n got:  %s", want, got)
	}
